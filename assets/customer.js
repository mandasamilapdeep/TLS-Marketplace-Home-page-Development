const selectors = {
	...
	addressListForms: ".address-edit-form",
};
...
class CustomerAddresses {
	...
	_getElements() {
		...
		return container
			? {
					...
					addressListForms: container.querySelectorAll(
						selectors.addressListForms
					),
			  }
			: {};
	}
		...
		if (target.getAttribute("data-type") === "reset") {
			...
			items.forEach((el) => {
				...
				if (el.getAttribute(attributes.expandedTarget) === "false") {
					...
					// Keep your existing country setup logic
	...
	_handleAddEditButtonClick = ({ currentTarget }) => {
		...
		this.elements.addressListForms.forEach((form) => {
